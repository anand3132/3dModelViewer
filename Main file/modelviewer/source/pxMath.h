...
//    }
	...
	static float SINF(int ang)	{		return (float)sin(DEG2RAD(ang));	}

	static float COSF(int ang)	{		return (float)cos(DEG2RAD(ang));	}

	static float SINF(float ang){		return (float)sin(DEG2RAD(ang));	}

	static float COSF(float ang){		return (float)cos(DEG2RAD(ang));	}
	...
	static int SQRT(int val)		{		return (int)sqrt((float)val);	}

#if 0
	static unsigned int SQRTX(unsigned int val)	{		return FTOX(SQRT(XTOF(val)));	}

	static unsigned int SQRTX(__int64_t val)	{		return FTOX(SQRT(XTOF(val)));	}
#endif
